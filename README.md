...
Полноценная игра в духе Douchebag для Telegram Mini App. После любых правок: `git add .` → `git commit -m "..."` → `git push`.: ты оказываешься дома у молодого Павла Дурова (без богатства), а состояние смотришь в телефоне.
